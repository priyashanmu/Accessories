...
<div class="carousel-inner" role="listbox">
 ...
 <img src="<c:url value='/resources/image/rin3.jpg'/>"  width="504" height="236">
    </div>

    <div class="item">
      <img src="<c:url value='/resources/image/r1.jpg'/>" width="504" height="236">
    </div>
    <div class="item">
      <img src="<c:url value='/resources/image/rin1.jpg'/>" width="504" height="236">
    </div>
...
<div class="section" id="show">
 ...
 <div class="caption">
        ...
        <div class="item  col-xs-4 col-lg-4">
            <div class="thumbnail">
                <img src="<c:url value='/resources/image/rin6.jpg'/>" class="img-thumbnails"  width="304" height="236">
 ...
 <div class="caption">
        ...
        <div class="item  col-xs-4 col-lg-4">
            <div class="thumbnail">
                <img src="<c:url value='/resources/image/rin3.jpg'/>" class="img-thumbnails"  width="304" height="236">
 ...
 <div class="caption">
        ...
        <div class="item  col-xs-4 col-lg-4">
            <div class="thumbnail">
                <img src="<c:url value='/resources/image/rin8.jpg'/>" class="img-thumbnails"  width="304" height="236">
 ...
 <div class="caption">
        ...
        <div class="item  col-xs-4 col-lg-4">
            <div class="thumbnail">
                <img src="<c:url value='/resources/image/rin10.jpg'/>" class="img-thumbnails"  width="304" height="236">
