...
<div class="carousel-inner" role="listbox">
 ...
 <img src="<c:url value='/resources/image/ear5.jpg'/>"  width="504" height="236">
    </div>

    <div class="item">
      <img src="<c:url value='/resources/image/ear9.jpg'/>" width="504" height="236">
    </div>
    <div class="item">
      <img src="<c:url value='/resources/image/ear11.jpg'/>" width="504" height="236">
    </div>
 ...
 <div class="caption">
        ...
        <div class="item  col-xs-4 col-lg-4">
            <div class="thumbnail">
                <img src="<c:url value='/resources/image/ear4.jpg'/>" class="img-thumbnails"  width="304" height="236">
 ...
 <div class="caption">
        ...
        <div class="item  col-xs-4 col-lg-4">
            <div class="thumbnail">
                <img src="<c:url value='/resources/image/ear10.jpg'/>" class="img-thumbnails"  width="304" height="236">
 ...
 <div class="caption">
        ...
        <div class="item  col-xs-4 col-lg-4">
            <div class="thumbnail">
                <img src="<c:url value='/resources/image/ear2.jpg'/>" class="img-thumbnails"  width="304" height="236">
 ...
 <div class="caption">
        ...
        <div class="item  col-xs-4 col-lg-4">
            <div class="thumbnail">
                <img src="<c:url value='/resources/image/ear12.jpg'/>" class="img-thumbnails"  width="304" height="236">
